...
// Create a new sessino for an existing user
...
func (user *User) Create() (err error) {
	...
	// you're always using a sequence. You need to use the RETURNING keyword int your insert to get this
	...
	// use QuerRow to return a row and scan the returned id into the User struct
...
// Update user infomation in the database
