...
fn render_shape(mut gizmos: Gizmos, query: Query<(&Shape, &Transform)>) {
...
fn ray_cast_system(
    ...
    for (volume, mut intesects) in volumes.iter_mut() {
